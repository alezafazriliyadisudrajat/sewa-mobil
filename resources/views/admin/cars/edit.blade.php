  ...
  <div class="row">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
              <form action="{{ route('update', $car->id) }}" method="POST" enctype="multipart/form">
                  @csrf
                  @method('post')
                  ...
                  <div class="form-group">
                      ...
                      <select name="audio" id="audio" class="form-control">
                          ...
                          <option  {{ $car->audiok === 0? 'selected' : null}} value="0">Tidak Tersedia</option>
                      </select>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                          {{-- <form action="{{ route('update', $car->id) }}" method="POST" enctype="multipart/form">
                              ...
                              @method('put') --}}
                              <div class="form-group">
                                <img src="{{ asset("assets/images/cover/". $car->gambar ) }}" class="img-fluid" alt="">
                              </div>
                              <div class="form-group">
